...
def RenewSiteTemplate2():
    ...
    [humidity,rainProbability,apparrentemp] = doaction.WeatherElement(cityID,sitenlat,sitenlon)
...
def RenewNearSiteTemplate2():
    ...
    for i in range(5): 
        ...
        [humidity,rainProbability,apparrentemp] = doaction.WeatherElement(sitecityID[i],sitenlat[i],sitenlon[i])
        recommendScore = doaction.GradingRecommendScore(apparrentemp,rainProbability,populationPercentage)
